...
?>
  ...
  <!-- Full Page Intro -->
  <div class="view" style="background-image: url('http://localhost/wp-content/themes/jhpiego/img/home-top-bg.png'); background-repeat: no-repeat; background-size: cover; background-position: center center;">
